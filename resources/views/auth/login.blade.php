...
<div class="login-page">
    <div class="form">
        <form class="register-form" action="{{ url('register') }}" method="post">
            {{ csrf_field() }}
            <input type="text" name="name" value="{{ old('name') }}" placeholder="Tên của bạn"/>
            ...
            <button>Tạo tại khoản</button>
            <p class="message">Bạn đã đăng ký? <a href="#">Đăng nhập</a></p>
        </form>
        ...
        <h3>Hoặc liên hệ chúng tôi.</h3>
        <p>Hotline: 19006969</p>
        <p>Email: vietqr@vietqr.vn</p>
    </div>
</div>
